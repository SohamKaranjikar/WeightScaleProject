...
in the appendix. We only had one external dependency, a
\myLink{https://github.com/bogde/HX711}{HX711 library}. This library allowed us
to communicate with the amplifier chip quite easily as the low level
